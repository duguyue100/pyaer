    ...
    try:
        ...
        if data is not None:
            ...
            if frames.shape[0] != 0:
                ...
                frame = cv2.resize(
                    frame, dsize=(692, 520), interpolation=cv2.INTER_LINEAR
                )
            ...
            if num_pol_event != 0:
                ...
                g_1, _, _ = np.histogram2d(
                    pol_events[pol_g_1, 2],
                    pol_events[pol_g_1, 1],
                    bins=(260, 346),
                    range=histrange,
                )
                ...
                g_2, _, _ = np.histogram2d(
                    pol_events[pol_g_2, 2],
                    pol_events[pol_g_2, 1],
                    bins=(260, 346),
                    range=histrange,
                )
                ...
                img = np.vstack((np.hstack((ir, ig_2)), np.hstack((ig_1, ib))))
