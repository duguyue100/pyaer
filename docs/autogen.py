...
PAGES = [
    {
        ...
        'methods': [
            ...
            device.USBDevice.obtain_device_info,
            ...
            device.USBDevice.get_imu9_event,
    ...
    },
    {
        ...
        'methods': [
            ...
            edvs.eDVS.set_noise_filter,
            edvs.eDVS.enable_noise_filter,
            edvs.eDVS.disable_noise_filter,
            edvs.eDVS.get_event,
        ],
    },
    {
